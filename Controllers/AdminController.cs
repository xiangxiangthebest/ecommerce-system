...
namespace EcommerceSystem.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public AdminController(AppDbContext context, IProductReportService productReportService, IReviewReportService reviewReportService, IUserService userService)
        {
            _context = context;
